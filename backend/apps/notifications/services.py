...
def push_notification(*, user, type, title, body="", actor=None, entity=None):
    ...
    if preferences is not None and not preferences.in_app_notifications and type not in {Notification.Type.ACCOUNT_WARNING, Notification.Type.VERIFICATION_APPROVED, Notification.Type.VERIFICATION_REJECTED, Notification.Type.VERIFICATION_NEEDS_MORE}:
        return None
